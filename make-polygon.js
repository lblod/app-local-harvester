...
WHERE {
  ...
  FILTER(geof:sfWithin(?wkt, "<http://www.opengis.net/def/crs/EPSG/0/31370> POLYGON((${minLon} ${minLat}, ${minLon} ${maxLat}, ${maxLon} ${maxLat}, ${maxLon} ${minLat}, ${minLon} ${minLat}))"^^geo:wktLiteral))
 }
`)
